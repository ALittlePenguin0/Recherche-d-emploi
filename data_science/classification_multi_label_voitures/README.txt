...
Une fois le modèle entraîné dans le notebook **"classification_voitures_notebook.ipynb"**, nous créons un API avec le framework Flask dans le notebook __"api.ipynb"__.
