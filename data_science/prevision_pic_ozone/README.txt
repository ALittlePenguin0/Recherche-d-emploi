Dans ce sous-répertoire, vous retrouverez un notebook d'apprentissage concernant des techniques de Machine Learning (régression: régression linéaire; classification: arbre de décision, régression logistique; réseaux de neuronnes) dans le cadre d'une prévision du pic d'ozone en langage R. De plus, il existe questions pour renforcer l'apprentissage. Le fichier notebook se nomme "prevision_pic_ozone_notebook.ipynb".
